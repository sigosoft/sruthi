...
include "config.php";
  $counter =0;
  $result     = mysqli_query($conn,"SELECT * from category WHERE block='0'");
...
<td><a class="btn btn-danger btn-sm" href="unblockm.php?id=<?php echo $row1['cat_id']; ?>"><button type="button" class="btn btn-danger">Enable</button></a></td>
<td><a class="btn btn-danger btn-sm" href="editdiscat.php?id=<?php echo $row1['cat_id']; ?>"><button type="button" class="btn btn-danger" onclick="return confirm('Are you sure to edit?')">Edit</button></a></td>
